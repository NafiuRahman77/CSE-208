    ...
    void search1(string s){
        int check=1;
         ...
         int index=hashFunction1(s,num);
          ...
          if(check==1) {//cout<<"this string doesn't exists";}
...
int main(){
 ...
 start = chrono::steady_clock::now();
    ...
    cout<<"Separate chaining"<<","<<results[0]<<","<< "N/A"<<","<<results[1]<<","<<"N/A"<<endl;
    cout<<"Linear probing"<<","<<results[12]<<","<< results[13]<<","<<results[14]<<","<<results[15]<<endl;
    cout<<"Quadratic probing"<<","<<results[36]<<","<< results[37]<<","<<results[38]<<","<<results[39]<<endl;
    cout<<"Double hashing"<<","<<results[60]<<","<< results[61]<<","<<results[62]<<","<<results[63]<<endl;

    cout << "  Table:6 Performance of various collision resolution methods in load factor 0.5   " << endl;
    cout << ",    Before Deletion,,    After Deletion" << endl;
    cout << "Method,Avg Search Time, Avg no of probes,Avg Search Time, Avg no of probes" << endl;
    cout<<"Separate chaining"<<","<<results[2]<<","<< "N/A"<<","<<results[3]<<","<<"N/A"<<endl;
    cout<<"Linear probing"<<","<<results[16]<<","<< results[17]<<","<<results[18]<<","<<results[15+4]<<endl;
    cout<<"Quadratic probing"<<","<<results[36+4]<<","<< results[37+4]<<","<<results[38+4]<<","<<results[39+4]<<endl;
    cout<<"Double hashing"<<","<<results[60+4]<<","<< results[61+4]<<","<<results[62+4]<<","<<results[63+4]<<endl;

    cout << "  Table:5 Performance of various collision resolution methods in load factor 0.6   " << endl;
    cout << ",    Before Deletion,,    After Deletion" << endl;
    cout << "Method,Avg Search Time, Avg no of probes,Avg Search Time, Avg no of probes" << endl;
    cout<<"Separate chaining"<<","<<results[4]<<","<< "N/A"<<","<<results[5]<<","<<"N/A"<<endl;
    cout<<"Linear probing"<<","<<results[12+8]<<","<< results[13+8]<<","<<results[14+8]<<","<<results[15+8]<<endl;
    cout<<"Quadratic probing"<<","<<results[36+8]<<","<< results[37+8]<<","<<results[38+8]<<","<<results[39+8]<<endl;
    cout<<"Double hashing"<<","<<results[60+8]<<","<< results[61+8]<<","<<results[62+8]<<","<<results[63+8]<<endl;

    cout << "  Table:5 Performance of various collision resolution methods in load factor 0.7   " << endl;
    cout << ",    Before Deletion,,    After Deletion" << endl;
    cout << "Method,Avg Search Time, Avg no of probes,Avg Search Time, Avg no of probes" << endl;
    cout<<"Separate chaining"<<","<<results[6]<<","<< "N/A"<<","<<results[7]<<","<<"N/A"<<endl;
    cout<<"Linear probing"<<","<<results[12+12]<<","<< results[13+12]<<","<<results[14+12]<<","<<results[15+12]<<endl;
    cout<<"Quadratic probing"<<","<<results[36+12]<<","<< results[37+12]<<","<<results[38+12]<<","<<results[39+12]<<endl;
    cout<<"Double hashing"<<","<<results[60+12]<<","<< results[61+12]<<","<<results[62+12]<<","<<results[63+12]<<endl;

    cout << "  Table:5 Performance of various collision resolution methods in load factor 0.8   " << endl;
    cout << ",    Before Deletion,,    After Deletion" << endl;
    cout << "Method,Avg Search Time, Avg no of probes,Avg Search Time, Avg no of probes" << endl;
    cout<<"Separate chaining"<<","<<results[8]<<","<< "N/A"<<","<<results[9]<<","<<"N/A"<<endl;
    cout<<"Linear probing"<<","<<results[12+16]<<","<< results[13+16]<<","<<results[14+16]<<","<<results[15+16]<<endl;
    cout<<"Quadratic probing"<<","<<results[36+16]<<","<< results[37+16]<<","<<results[38+16]<<","<<results[39+16]<<endl;
    cout<<"Double hashing"<<","<<results[60+16]<<","<< results[61+16]<<","<<results[62+16]<<","<<results[63+16]<<endl;

    cout << "  Table:5 Performance of various collision resolution methods in load factor 0.9   " << endl;
    cout << ",    Before Deletion,,    After Deletion" << endl;
    cout << "Method,Avg Search Time, Avg no of probes,Avg Search Time, Avg no of probes" << endl;
    cout<<"Separate chaining"<<","<<results[10]<<","<< "N/A"<<","<<results[11]<<","<<"N/A"<<endl;
    cout<<"Linear probing"<<","<<results[12+20]<<","<< results[13+20]<<","<<results[14+20]<<","<<results[15+20]<<endl;
    cout<<"Quadratic probing"<<","<<results[36+20]<<","<< results[37+20]<<","<<results[38+20]<<","<<results[39+20]<<endl;
    cout<<"Double hashing"<<","<<results[60+20]<<","<< results[61+20]<<","<<results[62+20]<<","<<results[63+20]<<endl;
